...
void Grid::memory_allocation() {
    ...
    if (inverse_flag) {
        ...
        t_loc_inv_ani   = (CUSTOMREAL *) malloc(sizeof(CUSTOMREAL) * n_inv_J_loc_ani * n_inv_K_loc_ani * n_inv_grids);
        p_loc_inv_ani   = (CUSTOMREAL *) malloc(sizeof(CUSTOMREAL) * n_inv_I_loc_ani * n_inv_K_loc_ani * n_inv_grids);
        ...
        Kdensity_inv_loc= (CUSTOMREAL *) malloc(sizeof(CUSTOMREAL) * n_total_loc_inv_grid);
        ...
        Kdensity_update_loc = (CUSTOMREAL *) malloc(sizeof(CUSTOMREAL) * n_total_loc_grid_points);
...
void Grid::memory_deallocation() {
   // shm array deallocation is done in shm_memory_deallocation() if shm is used
    ...
    if (inverse_flag){
        ...
        free(Kxi_inv_loc);
        free(Keta_inv_loc);
        free(Kdensity_inv_loc);
        free(Ks_update_loc);
        free(Kxi_update_loc);
        free(Keta_update_loc);
        free(Kdensity_update_loc);
