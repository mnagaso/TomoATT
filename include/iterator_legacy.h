...
public:
    Iterator_legacy_tele(InputParams& , Grid&, Source&, IO_utils&, bool, bool);
protected:
    void do_sweep_adj(int, Grid&, InputParams&) override ; // do sweeping for adjoint routine
    virtual void do_sweep(int, Grid&, InputParams&) {}; // do sweeping
};
...
public:
    Iterator_legacy_1st_order_tele(InputParams&, Grid&, Source&, IO_utils&, bool, bool);
    //void run_iteration_forward(InputParams&, Grid&, IO_utils&, bool&);
private:
    void do_sweep(int, Grid&, InputParams&) override ; // do sweeping
...
public:
    Iterator_legacy_3rd_order_tele(InputParams&, Grid&, Source&, IO_utils&, bool, bool);
    //void run_iteration_forward(InputParams&, Grid&, IO_utils&, bool&);
private:
    void do_sweep(int, Grid&, InputParams&) override ; // do sweeping
