...
public:
    Iterator_level(InputParams&, Grid&, Source&, IO_utils&, bool, bool, bool);
protected:
...
public:
    Iterator_level_tele(InputParams& , Grid&, Source&, IO_utils&, bool, bool, bool);
protected:
    void do_sweep_adj(int, Grid&, InputParams&) override ; // do sweeping for adjoint routine
    virtual void do_sweep(int, Grid&, InputParams&) {}; // do sweeping
};
...
public:
    Iterator_level_1st_order(InputParams&, Grid&, Source&, IO_utils&, bool, bool, bool);
private:
...
public:
    Iterator_level_3rd_order(InputParams&, Grid&, Source&, IO_utils&, bool, bool, bool);
private:
    void do_sweep(int, Grid&, InputParams&) override ; // do sweeping
};
...
// public:
//     Iterator_level_1st_order_upwind(InputParams&, Grid&, Source&, IO_utils&, bool, bool);
// private:
//     void do_sweep(int, Grid&, InputParams&) override ; // do sweeping
// }
...
public:
    Iterator_level_1st_order_tele(InputParams&, Grid&, Source&, IO_utils&, bool, bool, bool);
private:
    void do_sweep(int, Grid&, InputParams&) override ; // do sweeping
};
...
public:
    Iterator_level_3rd_order_tele(InputParams&, Grid&, Source&, IO_utils&, bool, bool, bool);
private:
    void do_sweep(int, Grid&, InputParams&) override ; // do sweeping
};
