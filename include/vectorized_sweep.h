...
//                         );
    ...
    __m256d tmp2 = _mm256_add_pd(v_eps,my_square(_mm256_add_pd(v_m__,_mm256_add_pd(_mm256_mul_pd(_mm256_set1_pd(-2.0),v_c__),v_p__))));
...
inline void fake_stencil_3rd_apre_simd(__m256d& v_tau,__m256d& v_fac_a,__m256d& v_fac_b, __m256d& v_fac_c, __m256d& v_fac_f, \
    ...
    __m256d Htau = _mm256_mul_pd(v_fac_a,my_square(_mm256_add_pd(_mm256_mul_pd(v_T0r,v_tau),_mm256_mul_pd(v_T0v,_mm256_mul_pd(_mm256_add_pd(v_pr1,v_pr2),_mm256_set1_pd(0.5))))));

    // Htau += v_fac_b * square(v_T0r * v_tau + v_T0v * (v_pt1 + v_pt2)*0.5))
    Htau = _mm256_add_pd(Htau,_mm256_mul_pd(v_fac_b,my_square(_mm256_add_pd(_mm256_mul_pd(v_T0r,v_tau),_mm256_mul_pd(v_T0v,_mm256_mul_pd(_mm256_add_pd(v_pt1,v_pt2),_mm256_set1_pd(0.5)))))));
    // Htau += v_fac_c * square(v_T0p * v_tau + v_T0v * (v_pp1 + v_pp2)*0.5))
    Htau = _mm256_add_pd(Htau,_mm256_mul_pd(v_fac_c,my_square(_mm256_add_pd(_mm256_mul_pd(v_T0p,v_tau),_mm256_mul_pd(v_T0v,_mm256_mul_pd(_mm256_add_pd(v_pp1,v_pp2),_mm256_set1_pd(0.5)))))));
