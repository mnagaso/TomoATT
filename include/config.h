...
inline const int  N_ITER_MAX_SRC_RELOC  = 1001;   // max iteration for source location
inline CUSTOMREAL TOL_SRC_RELOC   = 1e-1; // threshold of the norm of gradient for stopping single earthquake location
