    ...
    for (int i_grid = 0; i_grid < n_inv_grids; i_grid++) {
        ...
        for (int k = k_start; k < k_end; k++) {
            ...
            for (int ii_invr = 0; ii_invr < n_inv_K_loc_ani-1; ii_invr++){
                // increasing or decreasing order
                if (in_between(r_glob, grid.r_loc_inv_ani[I2V_INV_ANI_GRIDS_1DK(ii_invr,i_grid)], grid.r_loc_inv_ani[I2V_INV_ANI_GRIDS_1DK(ii_invr+1,i_grid)])) {
                    kdr_ani = ii_invr;
                    r_r_ani = calc_ratio_between(r_glob, grid.r_loc_inv_ani[I2V_INV_ANI_GRIDS_1DK(ii_invr,i_grid)], grid.r_loc_inv_ani[I2V_INV_ANI_GRIDS_1DK(ii_invr+1,i_grid)]);
                    break;
                }
            }
            ...
            for (int j = j_start; j < j_end; j++) {
                ...
                for (int ii_invt = 0; ii_invt < n_inv_J_loc_ani-1; ii_invt++){
                    //if ((t_glob - grid.t_loc_inv_ani[I2V_INV_ANI_GRIDS_1DJ(ii_invt,i_grid)]) * (t_glob - grid.t_loc_inv_ani[I2V_INV_ANI_GRIDS_1DJ(ii_invt+1,i_grid)]) <= _0_CR) {
                    if (in_between(t_glob, grid.t_loc_inv_ani[I2V_INV_ANI_GRIDS_1DJ(ii_invt,i_grid)], grid.t_loc_inv_ani[I2V_INV_ANI_GRIDS_1DJ(ii_invt+1,i_grid)])) {
                        jdt_ani = ii_invt;
                        r_t_ani = calc_ratio_between(t_glob, grid.t_loc_inv_ani[I2V_INV_ANI_GRIDS_1DJ(ii_invt,i_grid)], grid.t_loc_inv_ani[I2V_INV_ANI_GRIDS_1DJ(ii_invt+1,i_grid)]);
                        break;
                    }
                }
                ...
                for (int i = i_start; i < i_end; i++) {
                    ...
                    for (int ii_invp = 0; ii_invp < n_inv_I_loc_ani-1; ii_invp++){
                        if (in_between(p_glob, grid.p_loc_inv_ani[I2V_INV_ANI_GRIDS_1DI(ii_invp,i_grid)], grid.p_loc_inv_ani[I2V_INV_ANI_GRIDS_1DI(ii_invp+1,i_grid)])) {
                            idp_ani = ii_invp;
                            r_p_ani = calc_ratio_between(p_glob, grid.p_loc_inv_ani[I2V_INV_ANI_GRIDS_1DI(ii_invp,i_grid)], grid.p_loc_inv_ani[I2V_INV_ANI_GRIDS_1DI(ii_invp+1,i_grid)]);
                            break;
                        }
                    }
                    ...
                    grid.Ks_inv_loc[  I2V_INV_KNL(    idp,    jdt,    kdr)]     += (_1_CR-r_r)    *(_1_CR-r_t)    *(_1_CR-r_p)    *grid.Ks_loc[  I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Keta_inv_loc[I2V_INV_ANI_KNL(idp_ani,jdt_ani,kdr_ani)] += (_1_CR-r_r_ani)*(_1_CR-r_t_ani)*(_1_CR-r_p_ani)*grid.Keta_loc[I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Kxi_inv_loc[ I2V_INV_ANI_KNL(idp_ani,jdt_ani,kdr_ani)] += (_1_CR-r_r_ani)*(_1_CR-r_t_ani)*(_1_CR-r_p_ani)*grid.Kxi_loc[ I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);

                    grid.Ks_inv_loc[  I2V_INV_KNL(    idp,    jdt,    kdr    +1)] += r_r    *(_1_CR-r_t)    *(_1_CR-r_p)    *grid.Ks_loc[  I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Keta_inv_loc[I2V_INV_ANI_KNL(idp_ani,jdt_ani,kdr_ani+1)] += r_r_ani*(_1_CR-r_t_ani)*(_1_CR-r_p_ani)*grid.Keta_loc[I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Kxi_inv_loc[ I2V_INV_ANI_KNL(idp_ani,jdt_ani,kdr_ani+1)] += r_r_ani*(_1_CR-r_t_ani)*(_1_CR-r_p_ani)*grid.Kxi_loc[ I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);

                    grid.Ks_inv_loc[  I2V_INV_KNL(    idp,    jdt    +1,kdr)]     += (_1_CR-r_r)    *r_t    *(_1_CR-r_p)    *grid.Ks_loc[  I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Keta_inv_loc[I2V_INV_ANI_KNL(idp_ani,jdt_ani+1,kdr_ani)] += (_1_CR-r_r_ani)*r_t_ani*(_1_CR-r_p_ani)*grid.Keta_loc[I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Kxi_inv_loc[ I2V_INV_ANI_KNL(idp_ani,jdt_ani+1,kdr_ani)] += (_1_CR-r_r_ani)*r_t_ani*(_1_CR-r_p_ani)*grid.Kxi_loc[ I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);

                    grid.Ks_inv_loc[  I2V_INV_KNL(    idp    +1,jdt,    kdr)]     += (_1_CR-r_r)    *(_1_CR-r_t)    *r_p    *grid.Ks_loc[  I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Keta_inv_loc[I2V_INV_ANI_KNL(idp_ani+1,jdt_ani,kdr_ani)] += (_1_CR-r_r_ani)*(_1_CR-r_t_ani)*r_p_ani*grid.Keta_loc[I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Kxi_inv_loc[ I2V_INV_ANI_KNL(idp_ani+1,jdt_ani,kdr_ani)] += (_1_CR-r_r_ani)*(_1_CR-r_t_ani)*r_p_ani*grid.Kxi_loc[ I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);

                    grid.Ks_inv_loc[  I2V_INV_KNL(    idp,    jdt    +1,kdr    +1)] += r_r    *r_t    *(_1_CR-r_p)    *grid.Ks_loc[  I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Keta_inv_loc[I2V_INV_ANI_KNL(idp_ani,jdt_ani+1,kdr_ani+1)] += r_r_ani*r_t_ani*(_1_CR-r_p_ani)*grid.Keta_loc[I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Kxi_inv_loc[ I2V_INV_ANI_KNL(idp_ani,jdt_ani+1,kdr_ani+1)] += r_r_ani*r_t_ani*(_1_CR-r_p_ani)*grid.Kxi_loc[ I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);

                    grid.Ks_inv_loc[  I2V_INV_KNL(    idp    +1,jdt,    kdr    +1)] += r_r    *(_1_CR-r_t)    *r_p    *grid.Ks_loc[  I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Keta_inv_loc[I2V_INV_ANI_KNL(idp_ani+1,jdt_ani,kdr_ani+1)] += r_r_ani*(_1_CR-r_t_ani)*r_p_ani*grid.Keta_loc[I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Kxi_inv_loc[ I2V_INV_ANI_KNL(idp_ani+1,jdt_ani,kdr_ani+1)] += r_r_ani*(_1_CR-r_t_ani)*r_p_ani*grid.Kxi_loc[ I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);

                    grid.Ks_inv_loc[  I2V_INV_KNL(    idp    +1,jdt    +1,kdr)]     += (_1_CR-r_r)    *r_t    *r_p    *grid.Ks_loc[  I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Keta_inv_loc[I2V_INV_ANI_KNL(idp_ani+1,jdt_ani+1,kdr_ani)] += (_1_CR-r_r_ani)*r_t_ani*r_p_ani*grid.Keta_loc[I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Kxi_inv_loc[ I2V_INV_ANI_KNL(idp_ani+1,jdt_ani+1,kdr_ani)] += (_1_CR-r_r_ani)*r_t_ani*r_p_ani*grid.Kxi_loc[ I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);

                    grid.Ks_inv_loc[  I2V_INV_KNL(    idp    +1,jdt    +1,kdr    +1)] += r_r    *r_t    *r_p    *grid.Ks_loc[  I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Keta_inv_loc[I2V_INV_ANI_KNL(idp_ani+1,jdt_ani+1,kdr_ani+1)] += r_r_ani*r_t_ani*r_p_ani*grid.Keta_loc[I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
                    grid.Kxi_inv_loc[ I2V_INV_ANI_KNL(idp_ani+1,jdt_ani+1,kdr_ani+1)] += r_r_ani*r_t_ani*r_p_ani*grid.Kxi_loc[ I2V(i_loc,j_loc,k_loc)]/std::sqrt(grid.Kdensity_loc[I2V(i_loc,j_loc,k_loc)]);
