...
# --------- STEP 4, relocate earthquake first --------- 
mpirun -n 8 --allow-run-as-root --oversubscribe ../../build/bin/TOMOATT -i input_params/input_params_reloc_abs.yaml

# --------- STEP 5, update model parameters and relocate earthquake simultaneously --------- 
# mpirun -n 8 --allow-run-as-root --oversubscribe ../../build/bin/TOMOATT -i input_params/input_params_inv_abs_reloc_abs.yaml

# --------- STEP 6, ---------
# run all cells of '5_compare_location_result.ipynb' to compare the relocated result with the true result
# run all cells of '6_plot_location_result.ipynb' to show the relocated result

# --------- STEP 7, ---------
# run all cells of '7_plot_ckb_model.ipynb' and '8_plot_inversion_result.ipynb' to show the results
