...
mpirun -n 2 --allow-run-as-root ../../build/bin/TOMOATT -i 3_input_params/input_params_N41.yml

# run for forward simulation in the mesh of 61*61*61
mpirun -n 2 --allow-run-as-root ../../build/bin/TOMOATT -i 3_input_params/input_params_N61.yml

# run for forward simulation in the mesh of 81*81*81
mpirun -n 2 --allow-run-as-root ../../build/bin/TOMOATT -i 3_input_params/input_params_N81.yml

# run for forward simulation in the mesh of 121*121*121
mpirun -n 2 --allow-run-as-root ../../build/bin/TOMOATT -i 3_input_params/input_params_N121.yml

# run for forward simulation in the mesh of 161*161*161
mpirun -n 2 --allow-run-as-root ../../build/bin/TOMOATT -i 3_input_params/input_params_N161.yml
