...
CC=mpiicc  \
CFLAGS=" \
-I/app/intel/xe2019/compilers_and_libraries_2019.0.117/linux/mpi/intel64/include \
-L/app/intel/xe2019/compilers_and_libraries_2019.0.117/linux/mpi/intel64/lib \
-fPIC -O3 -xHost -ip -fno-alias -align" \
CXX=mpiicpc \
CXXFLAGS=" \
-I/app/intel/xe2019/compilers_and_libraries_2019.0.117/linux/mpi/intel64/include \
-L/app/intel/xe2019/compilers_and_libraries_2019.0.117/linux/mpi/intel64/lib \
-fPIC -O3 -xHost -ip -fno-alias -align" \
./configure --with-pic --enable-parallel --enable-unsupported --enable-shared --enable-cxx --prefix=$(pwd)/../local_mpi_hdf5
